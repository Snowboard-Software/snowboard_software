...
# -*- coding: utf-8 -*-
#
# Snowboard Data Catalog documentation build configuration file, created by
...
copyright = '2021, Snowboard Software'
...
html_static_path = ['_static', '_static/custom.css', '_static/copybutton.css']
...
latex_documents = [
    (master_doc, 'SnowboardDataCatalog.tex', 'Snowboard Data Catalog Documentation',
